...
export const getPayementsServiceHandlers = (baseURL: string) => [
  ...
  http.get(`${baseURL}/v1/payments/:id`, (req) => {
    return HttpResponse.json({
      ...
      content:
        '00020126480014BR.GOV.BCB.PIX0126payments@fiapburger.com.br5204000053039865406999.995802BR5911Fiap Burger6009Sao Paulo622405202024112416101632B12963044944',
