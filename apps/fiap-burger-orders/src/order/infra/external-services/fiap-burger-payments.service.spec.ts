...
import { FiapBurgerPaymentService } from './fiap-burger-payments.service';

describe('MongooseFiapBurgerPaymentService', () => {
  let app: INestApplication;
  let target: FiapBurgerPaymentService;
  ...
  beforeEach(async () => {
    ...
    target = app.get(FiapBurgerPaymentService);
  ...
  it('should instantiate correctly', async () => {
    expect(target).toBeInstanceOf(FiapBurgerPaymentService);
  });
